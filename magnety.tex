...
\begin{keyword}
Five to ten keywords, preferrably chosen from the IFAC keyword list.
\end{keyword}
...
\texttt{ifacconf.cls}. Both files are vailable on the IFAC web site.
...
\LaTeX, you can process an external bibliography database or insert it
directly into the reference section. Footnotes should be avoided as
...
\bibliography{magnety}             % bib file to produce the bibliography
